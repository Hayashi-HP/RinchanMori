const RinchanGuide = (() => {
  ...
  const steps = [
    { title: 'ようこそ、りんちゃんの杜へ', text: '一人ひとりの一歩が、<br>みんなの杜を育てます。' },
    { title: '歩けば、木が育ちます', text: '歩くたびにあなたの木が育ち、<br>葉っぱや花が増えていきます。' },
    { title: 'ありがとうが届きます', text: '「ありがとう」が増えるほど、<br>杜はもっとにぎやかになります。' },
    { title: '無理せず、いこうね', text: 'あなたのペースで大丈夫。<br>楽しく続けることが一番です。' }
  ];
