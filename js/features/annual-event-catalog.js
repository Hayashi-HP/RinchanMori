const RinchanAnnualEventCatalog = (() => {
  ...
  const EVENTS = [
    ...
    { month:7,key:'tanabata',icon:'🎋',title:'七夕ウォーク',startDay:1,endDay:31,individualTarget:100000,theme:'願いと歩みで天の川をつくる',collectible:'短冊',participationBadge:'七夕の短冊',achievementBadge:'星空ウォーカー',text:'短冊に願いをこめて。みんなの一歩で天の川を完成させましょう。',module:{css:'../css/v125-tanabata.css?v=159',js:'../js/features/tanabata-event.js?v=159',global:'RinchanTanabataEvent'} },
