const RinchanAnnualEventCatalog = (() => {
  ...
  const EVENTS = [
    ...
    { month:7,key:'tanabata',icon:'🎋',title:'七夕の杜',startDay:1,endDay:31,individualTarget:100000,theme:'星空を楽しむ七夕の杜',collectible:'星のかけら',participationBadge:'七夕の夜',achievementBadge:'星空ウォーカー',text:'今日は七夕。みんなの願いが星空へ届きますように。',module:{css:'../css/v125-tanabata.css?v=160',js:'../js/features/tanabata-event.js?v=160',global:'RinchanTanabataEvent'} },
