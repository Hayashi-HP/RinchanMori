...
function renderHistoryV070(list){const box=document.getElementById('v070History');if(!box)return;if(!list.length){box.innerHTML='<p class="empty-note">まだ記録がありません。</p>';return;}box.innerHTML=list.map(a=>'<div class="history-row"><strong>'+v070ShortDate(a.date)+'</strong><span>'+v070Num(a.steps)+'歩</span><small>'+((a.comment||'').slice(0,18)||'記録しました')+'</small></div>').join('')}
