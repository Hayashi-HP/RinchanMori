...
function renderV070Mypage(){
  ...
  renderHistoryV070(list.slice(0,5));
...
function renderHistoryV070(list){const box=document.getElementById('v070History');if(!box)return;if(!list.length){box.innerHTML='<p class="empty-note">まだ記録がありません。</p>';return;}box.innerHTML=list.map(a=>'<div class="history-row"><strong>'+v070ShortDate(a.date)+'</strong><span>'+v070Num(a.steps)+'歩</span></div>').join('')}
