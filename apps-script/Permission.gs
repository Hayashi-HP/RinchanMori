...
ROLE_PERMISSIONS[ROLE_ADMIN] = [PERMISSION_VIEW_ADMIN, PERMISSION_VIEW_SYSTEM, PERMISSION_VIEW_DEPT, PERMISSION_MANAGE_USERS, PERMISSION_MANAGE_NEWS, PERMISSION_MANAGE_CHALLENGES, PERMISSION_EXPORT];
ROLE_PERMISSIONS[ROLE_SYSTEM] = [PERMISSION_VIEW_ADMIN, PERMISSION_VIEW_SYSTEM, PERMISSION_VIEW_DEPT, PERMISSION_MANAGE_USERS, PERMISSION_MANAGE_NEWS, PERMISSION_MANAGE_CHALLENGES, PERMISSION_EXPORT];
